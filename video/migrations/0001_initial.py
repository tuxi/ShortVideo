# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2018-04-03 07:36
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('video', videokit.models.VideoField(duration_field='video_duration', gif_field='video_gif', height_field='video_height', mimetype_field='video_mimetype', rotation_field='video_rotation', thumbnail_field='video_thumbnail', upload_to=video.models.upload_to, width_field='video_width')),
                ...
                ('video_gif', models.ImageField(blank=True, null=True, upload_to='')),
